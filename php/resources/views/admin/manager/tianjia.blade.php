...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea style="width: 500px;margin: 0;padding: 0;height: 160px" name="mg_remark" id="mg_remark" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" onKeyUp="$.Huitextarealength(this,100)"></textarea>
...
$(function(){
	...
	$("#form-member-add").submit(function (event) {
